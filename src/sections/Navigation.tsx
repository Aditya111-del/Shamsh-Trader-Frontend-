...
export default function Navigation() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Overlay */}
      <div 
        className={`md:hidden fixed inset-0 z-40 bg-[#050505]/95 backdrop-blur-xl flex flex-col items-center justify-center pointer-events-auto transition-opacity duration-300 ${
